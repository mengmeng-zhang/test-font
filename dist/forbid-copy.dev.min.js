    ...
    (0, _createClass2.default)(CopyListener, [{
      ...
      value: function update(local) {
        if ((0, _classPrivateFieldGet2.default)(this, _transfer) && (0, _classPrivateFieldGet2.default)(this, _loaded)) {
          ...
          this._trigger(EVENT_TIMEOUT, 'Font resource load time out'); // 字体资源加载超时
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ "./node_modules/@babel/runtime/helpers/classCallCheck.js"), __webpack_require__(/*! @babel/runtime/helpers/createClass */ "./node_modules/@babel/runtime/helpers/createClass.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_classCallCheck2, _createClass2) {
  ...
  var FontManager = /*#__PURE__*/function () {
    ...
    function FontManager(manager) {
      ...
      this.fontSets = [{
        fontName: fontName,
        fontUrl: config.FONT_BASE_URL + '/' + fontName + '/' + fontName,
        loaded: false
      }];
    }
    ...
    (0, _createClass2.default)(FontManager, [{
      ...
      value: function loadSpadeFile() {
        ...
        return new Promise(function (resolve, reject) {
          ...
          var fontName = _this.manager.getSystemFontName();

          var SPADES_URL = '/dist/fonts/' + fontName + config.SPADES_URL;
          xhr.open('GET', SPADES_URL, true);
      ...
      value: function buildFontDeclareStyle(fontUrl, fontName) {
        ...
        style.id = 'maia-copy-style-' + fontname;
        var fontFormat = '',
            fontFamilySrc = '';
        ...
        var newFontFamily = '"longhu-default-font-' + fontname + '", ' + oldFontFamily; // 罗列所有html标签
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = (function () {
  ...
  var _require = __webpack_require__(/*! ../data/index */ "./src/data/index.js"),
      STORAGE_COPY_COUNT = _require.STORAGE_COPY_COUNT,
      WARNING_TEXT = _require.WARNING_TEXT;

  var Config = '../config/index'; // 复制追加警告内容

  var additionData = function additionData(event) {
    event.preventDefault();
    var selection = window.getSelection(0).toString();
    var textData = selection + '\n' + WARNING_TEXT;
  ...
  /**
   * 监听用户复制动作，并记录
   * @param {*} flag 是否开启复制追加警告信息
   */


  var listenCopy = function listenCopy(flag) {
    window.addEventListener('copy', function (event) {
      if (window.localStorage) {
        var copyCount = Number(window.localStorage.getItem(STORAGE_COPY_COUNT));

        if (!copyCount || isNaN(Number(copyCount))) {
          window.localStorage.setItem(STORAGE_COPY_COUNT, 1);
        } else {
          copyCount += 1;
          window.localStorage.setItem(STORAGE_COPY_COUNT, copyCount);
        }

        if (copyCount > Config.COPY_COUNT) {
          console.log('进行运营数据上传');
          window.localStorage.setItem(STORAGE_COPY_COUNT, 0);
        }
      } // 开启复制追加龙湖警告信息


      flag && additionData(event);
    });
  };

  module.exports = listenCopy;
}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
      ...
      value: function update(local) {
        ...
        if (!local) {
          (0, _classPrivateFieldGet2.default)(this, _recorder).record().catch(function (errType) {
            ...
            console.log(errType); // this.#recorder.recordError(errType).catch(() => {
            // })
          });
        }
      }
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = (function () {
  ...
  var STORAGE_COPY_COUNT = 'maia_wm_copy_count';
  var WARNING_TEXT = '⚠️⚠️⚠️⚠️⚠️您复制的信息为龙湖内部信息，请不要在龙湖意外的环境发布，感谢您的支持与配合⚠️⚠️⚠️⚠️⚠️';
  module.exports = {
    HTMLTAGS: HTMLTAGS,
    ...
    STORAGE_COPY_COUNT: STORAGE_COPY_COUNT,
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = (function () {
  ...
  var listenCopy = __webpack_require__(/*! ./core/listenCopy */ "./src/core/listenCopy.js");
  /**
   * options:
   * {
   *    fontName: 全部操作系统默认字体(MicrosoftYahei) // 其实没有默认值
  ...
  var createCopyListener = function () {
    ...
    function createCopyListener(oaCount, appKey, options) {
      if (listener) {
        console.warn('Instances cannot be created more than once'); // 不能多次创建实例
